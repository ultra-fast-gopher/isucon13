...
func getReactionsHandler(c echo.Context) error {
	...
	for i := range reactionModels {
		reaction, err := fillReactionResponse(ctx, tx, reactionModels[i], &livestreamModel)
		if err != nil {
...
func fillReactionResponse(ctx context.Context, tx DB, reactionModel ReactionModel, cachedLivestreamModel *LivestreamModel) (Reaction, error) {
